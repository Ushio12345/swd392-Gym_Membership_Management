...
const GymPackagePage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Gym package booked successfully!")
  }
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="w-full">
          <Card className="bg-white/10 backdrop-blur-sm border-gray-600">
            <CardHeader>
              <CardTitle className="text-white text-2xl text-center">Buy Gym Package</CardTitle>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  className="w-full bg-red-500 hover:bg-red-600 text-white font-semibold py-4 h-12 text-base"
